...
| **Usual Routine**     | `get_frequent_sets`     | "Make me a routine from what I usually do."            |
...
Persistent coaching context and plan proposals.

- **Coach Profile** (`sparky_manage_coach_profile`): "I can train 4 days a week, about an hour, dumbbells only — remember that." The assistant interviews you once (goals, availability, equipment, injuries, food preferences) and keeps the profile current from conversation.
- **Coaching Plans** (`sparky_generate_coaching_plan`): "Plan my training and meals for next week."
- **Workout Presets** (via `sparky_manage_exercise`): "Build me an upper/lower split from my equipment and save it as a preset."
