...
* AI Coach profile (`coach_profiles` table — coaching goals, training constraints, injuries and limitations, food preferences). This coaching context is not shareable and is never family-delegated.
