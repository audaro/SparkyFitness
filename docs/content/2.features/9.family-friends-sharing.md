...
* AI Coach profile (`coach_profiles` table — coaching goals, training constraints, experience level, injuries and limitations, food preferences, weekly set targets). This coaching context is not shareable and is never family-delegated.
