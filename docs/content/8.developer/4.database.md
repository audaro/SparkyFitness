...
| `coach_profiles` | Training and food context behind generation and AI chat — goals, days per week, session length, limitations, weekly set targets, experience level. Owner-only (Tier 1) |
