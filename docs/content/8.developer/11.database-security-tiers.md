...
| `coach_profiles` | AI coach context (goals, training constraints, experience level, injuries/limitations, food preferences, personal aliases, weekly set targets) | Owner-Only | Owner-Only |
