      ...
      <SafeAreaProvider>
        ...
        >
          ...
          <Stack.Screen
            ...
            options={createStackScreenOptions(t('screens.exercises', { defaultValue: 'Exercises' }), { headerBackTitle: t('navigation.exercise', { defaultValue: 'Exercise' }) })}
          />
          <Stack.Screen
            name="WorkoutPresetsLibrary"
            component={SafeWorkoutPresetsLibrary}
            options={createStackScreenOptions(t('screens.workoutPresets', { defaultValue: 'Workout Presets' }), { headerBackTitle: t('navigation.exercise', { defaultValue: 'Exercise' }) })}
          />
          <Stack.Screen
          ...
          <Stack.Screen
            ...
            options={({ route }) => createStackScreenOptions(route.params.entry.food_name ?? t('screens.foodEntry', { defaultValue: 'Food Entry' }), { headerBackTitle: t('navigation.diary', { defaultValue: 'Food' }) })}
          />
          <Stack.Screen
            name="EditLoggedMeal"
            component={SafeEditLoggedMeal}
            options={createStackScreenOptions(t('screens.editMeal', { defaultValue: 'Edit Meal' }), { headerBackTitle: t('navigation.diary', { defaultValue: 'Food' }) })}
          />
          <Stack.Screen
            name="MealTypeDetail"
            component={SafeMealTypeDetail}
            options={({ route }) => createStackScreenOptions(route.params.mealLabel ?? t('screens.meal', { defaultValue: 'Meal' }), { headerBackTitle: t('navigation.diary', { defaultValue: 'Food' }) })}
          />
          <Stack.Screen
          ...
          <Stack.Screen
            ...
            options={createStackScreenOptions(t('upNext.title', { defaultValue: "Today's Workout" }), { headerBackTitle: t('common.back', { defaultValue: 'Back' }) })}
          />
          <Stack.Screen
            name="PickMuscles"
            component={SafePickMuscles}
            options={createStackScreenOptions(t('upNext.pickMuscles', { defaultValue: 'Choose muscles' }), { headerBackTitle: t('upNext.title', { defaultValue: "Today's Workout" }) })}
          />
          <Stack.Screen
            name="OnDemandWorkouts"
            component={SafeOnDemandWorkouts}
            options={createStackScreenOptions(t('upNext.onDemand', { defaultValue: 'Quick workouts' }), { headerBackTitle: t('upNext.title', { defaultValue: "Today's Workout" }) })}
          />
          <Stack.Screen
            name="WorkoutAdd"
          ...
          <Stack.Screen
            ...
            options={({ route }) => createStackScreenOptions(route.params.session.name ?? t('screens.activity', { defaultValue: 'Activity' }), { headerBackTitle: t('navigation.exercise', { defaultValue: 'Exercise' }) })}
          />
          <Stack.Screen
            name="FastingDetail"
          ...
          <Stack.Screen
            ...
            options={createStackScreenOptions(t('screens.progressPhotoCapture', { defaultValue: 'Guided Capture' }), {
              presentation: 'modal',
              headerShown: false,
              ...(Platform.OS === 'android' ? androidModalAnimation : {}),
            })}
          ...
          <Stack.Screen
            ...
            options={createStackScreenOptions(t('screens.diarySettings', { defaultValue: 'Food Diary Settings' }), { headerBackTitle: t('navigation.settings', { defaultValue: 'Settings' }) })}
          />
          <Stack.Screen
          ...
          <Stack.Screen
            ...
            options={createStackScreenOptions(t('gymProfiles.listTitle', { defaultValue: 'Gym Profiles' }), { headerBackTitle: t('common.back', { defaultValue: 'Back' }) })}
          />
          <Stack.Screen
            name="ExercisePacks"
            component={SafeExercisePacks}
            options={createStackScreenOptions(t('exercisePacks.title', { defaultValue: 'Exercise Packs' }), { headerBackTitle: t('common.back', { defaultValue: 'Back' }) })}
          />
          <Stack.Screen
          ...
          <Stack.Screen
            ...
            options={createStackScreenOptions(t('screens.wellnessHub', { defaultValue: 'Wellness Hub' }), { headerBackTitle: t('navigation.dashboard', { defaultValue: 'Home' }) })}
          />
          <Stack.Screen
            name="CycleLogModal"
