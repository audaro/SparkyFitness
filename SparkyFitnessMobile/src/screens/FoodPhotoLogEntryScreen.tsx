        ...
        {isGrouped ? (
          ...
          <View className="flex-row items-center justify-between mb-4">
            ...
            <StepperInput
              ...
              // Unlabelled, this stepper announces its SF Symbol names:
              // VoiceOver reads the buttons as "add" and "remove" with nothing
              // to say what they change, and every other stepper on screen says
              // the same.
              accessibilityLabels={{
                decrement: t(
                  'foodPhotoLogEntry.accessibility.decreaseServings',
                  { defaultValue: 'Decrease servings' }
                ),
                input: t('foodPhotoLogEntry.accessibility.servingsValue', {
                  defaultValue: 'Servings',
                }),
                increment: t(
                  'foodPhotoLogEntry.accessibility.increaseServings',
                  { defaultValue: 'Increase servings' }
                ),
              }}
            />
          </View>
