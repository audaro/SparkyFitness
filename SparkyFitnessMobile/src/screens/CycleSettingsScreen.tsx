...
import {
  CYCLE_SETTING_LIMITS,
  UNCONFIGURED_CYCLE_SETTINGS,
...
const CycleSettingsScreen: React.FC<CycleSettingsScreenProps> = ({
  ...
  const { settings, isLoading, isError, refetch, updateSettings } =
    useCycleSettings();
  ...
  const cycleLengthVal =
    effectiveSettings.avg_cycle_length_override || CYCLE_DEFAULTS.cycleLength;
  const periodLengthVal =
    effectiveSettings.avg_period_length_override || CYCLE_DEFAULTS.periodLength;
  const lutealLengthVal =
    effectiveSettings.luteal_phase_length || CYCLE_DEFAULTS.lutealLength;
    ...
    return (
      ...
      >
        ...
        <StatusView
          icon="alert-circle"
          iconTone="danger"
          title={t('cycleSettings.loadFailed', {
            defaultValue: 'Could not load your settings',
          })}
          action={{
          ...
          <SettingsRow
            ...
            rightAccessory={
              <Switch
                ...
                accessibilityLabel={t('cycleSettings.enable.title', {
                  defaultValue: 'Enable Cycle & Pregnancy Tracking',
                })}
              />
            }
          ...
          <>
            ...
            >
              <SettingsRow
                ...
                subtitle={
                  effectiveSettings.avg_cycle_length_override
              ...
              <SettingsRow
                ...
                subtitle={
                  effectiveSettings.avg_period_length_override
                    ? t('cycleSettings.values.custom', {
                        defaultValue: 'Custom override',
                      })
                    : t('cycleSettings.values.defaultHistory', {
              ...
              {CYCLE_CONDITIONS.map((cond) => (
                <SettingsRow
                  ...
                  rightAccessory={
                    <Switch
                      value={
                        effectiveSettings.conditions?.includes(cond.value) ||
                        false
                      }
                      onValueChange={(val) =>
                        handleToggleCondition(cond.value, val)
                      }
                      accessibilityLabel={getConditionLabel(
                        cond.value,
                        cond.displayName
                      )}
                    />
                ...
                rightAccessory={
                  <Switch
                    ...
                    accessibilityLabel={t(
                      'cycleSettings.fields.showFertileWindow',
                      { defaultValue: 'Show Fertile Window' }
                    )}
                  />
                }
              ...
              <SettingsRow
                ...
                rightAccessory={
                  <Switch
                    ...
                    accessibilityLabel={t('cycleSettings.fields.discreetMode', {
                      defaultValue: 'Discreet Mode',
                    })}
                  />
                }
