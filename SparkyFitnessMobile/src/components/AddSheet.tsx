            ...
            <>
              ...
              <View className="flex-row">
                {renderExerciseOption(
                  t('addSheet.workout', { defaultValue: 'Start Workout' }),
                  t('addSheet.liveSets', {
                    defaultValue: 'Track sets as you go',
                  }),
                  'exercise-weights',
                  onStartWorkout
                )}
                {renderExerciseOption(
                  t('addSheet.activity', { defaultValue: 'Log Activity' }),
                  t('addSheet.durationDistance', {
                    defaultValue: 'Run, walk, ride: time & distance',
                  }),
                  'exercise-running-filled',
                  onAddActivity
                )}
                {renderExerciseOption(
                  t('addSheet.logWorkout', {
                    defaultValue: 'Log Past Workout',
                  }),
                  t('addSheet.pastSets', {
                    defaultValue: 'Sets you already did',
                  }),
                  'pencil',
                  onLogWorkout
                )}
