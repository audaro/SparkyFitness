...
export const RELABELLED_PATHS = [
  {
    muscle: 'lats',
    note: 'Back figure, the left wing under the armpit. Classed `obliques` upstream, which the web app folds into the abdominals — so before this override, tapping a lat selected Abs.',
    d:
  ...
  {
    muscle: 'lats',
    note: 'Back figure, the right wing under the armpit.',
    d:
  ...
  {
    muscle: 'middle back',
    note: 'Back figure, the left slab down the spine. Classed `traps` upstream; the region is mid and lower trapezius plus the rhomboids, which is what "middle back" means in this vocabulary.',
    d:
  ...
  {
    muscle: 'middle back',
    note: 'Back figure, the right slab down the spine.',
    d:
