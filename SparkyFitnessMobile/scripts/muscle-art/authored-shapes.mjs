...
export const AUTHORED_SHAPES = [
  {
    muscle: 'neck',
    note:
      'Front of the neck, between the jaw and the sternal notch. It tucks ' +
  ...
  },
  {
    muscle: 'adductors',
    note:
      'Inner thigh, left leg. The quads are drawn full-width with no ' +
  ...
  },
  {
    muscle: 'abductors',
    note:
      'Outer hip, left side of the back figure. The strip lateral to the ' +
