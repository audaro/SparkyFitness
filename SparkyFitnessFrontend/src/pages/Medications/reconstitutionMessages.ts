 ...
 */
export function reconstitutionFailureMessage(
  t: TFunction,
  ...
  switch (failure.reason) {
    case 'invalid_vial_amount':
      return t(
        'medications.recon.errors.invalidVialAmount',
...
export function reconstitutionWarningMessage(
  ...
  switch (warning.code) {
    case 'exceeds_syringe_capacity':
      return t(
        'medications.recon.warnings.exceedsSyringeCapacity',
    ...
    case 'below_measurable_precision':
      return t(
        'medications.recon.warnings.belowMeasurablePrecision',
